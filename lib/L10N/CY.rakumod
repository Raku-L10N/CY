...
#- Generated on 2025-06-24T12:38:54+02:00 by ./update-localization
...
role L10N::CY {
    ...
    method adverb-q2str (str $key) {
        my constant %mapping = "arae", "array", "slaes", "backslash", "cau", "closure", "dwbl", "double", "gweithred", "exec", "fformat", "format", "swyddogaeth", "function", "awr", "h", "stwnsh", "hash", "o-ddyfyniadau", "quotewords", "sgalar", "scalar", "sengl", "single", "i", "to", "gw", "w", "o-eiriau", "words", "gw", "ww";
        %mapping{$key} // $key
    }
