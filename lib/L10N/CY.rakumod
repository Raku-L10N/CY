...
role L10N::CY {
    ...
    method trait-is2ast {
        my constant %mapping = "wedi-eu-hadeiladu", "built", "copi", "copy", "rhagosodedig", "default", "ANGHOFIEDIG", "DEPRECATED", "cyfystyr", "equiv", "allforio", "export", "cudd-o-gefn", "hidden-from-backtrace", "cudd-o-DDEFNYDD", "hidden-from-USAGE", "gweithredu-manylion", "implementation-detail", "rhyddach", "looser", "nodol", "nodal", "pur", "pure", "amrwd", "raw", "rh", "rw", "prawf-haeriad", "test-assertion", "llymach", "tighter";
        my $ast := self.ast;
        my $name := $ast ?? $ast.simple-identifier !! self.Str;
        if %mapping{$name} -> $original {
            RakuAST::Name.from-identifier($original)
    ...
    method adverb-pc2str (str $key) {
        my constant %mapping = "dileu", "delete", "yn-bodoli", "exists";
        %mapping{$key} // $key
    }
    method adverb-q2str (str $key) {
        my constant %mapping = "arae", "array", "slaes", "backslash", "cau", "closure", "dwbl", "double", "gweithred", "exec", "fformat", "format", "swyddogaeth", "function", "awr", "h", "stwnsh", "hash", "o-ddyfyniadau", "quotewords", "sgalar", "scalar", "sengl", "single", "o-eiriau", "words", "gw", "ww";
        %mapping{$key} // $key
    }
    method adverb-rx2str (str $key) {
        my constant %mapping = "parhau", "continue", "cyn", "ex", "hollgynhwysfawr", "exhaustive", "byd-eang", "global", "ff", "i", "cas-anwybyddu", "ignorecase", "marc-anwybyddu", "ignoremark", "eg", "nd", "fed", "nth", "trof", "ov", "gorgyffwrdd", "overlap", "t", "p", "post", "pos", "clicied", "ratchet", "ydd", "rd", "o-r-un-achos", "samecase", "o-r-un-marc", "samemark", "un-gofod", "samespace", "i", "to";
        %mapping{$key} // $key
    }
    method named2str (str $key) {
        my constant %mapping = "absoliwt", "absolute", "o-weithredoedd", "actions", "ap", "api", "atodiad", "append", "arg", "args", "fel", "as", "yn", "at", "awd", "auth", "enw-sylfaen", "basename", "swp", "batch", "gwaedu", "bleed", "darlledu", "broadcast", "dal", "catch", "siec", "check", "agos", "close", "gorchymyn", "command", "ategu", "complement", "yn-hollol", "completely", "parhau", "continue", "rheolaeth", "control", "cyfrif", "count", "creu", "create", "creu-yn-unig", "createonly", "dyddiad", "date", "dydd", "day", "gradd", "degree", "dileu", "delete", "cyfenw", "dirname", "elem", "elems", "wedi-u-hallyrru", "emit-timed", "amg", "enc", "amgodio", "encoding", "diwedd", "end", "cyfeiliorni", "err", "bob", "every", "cyn", "ex", "unigryw", "exclusive", "hollgynhwysfawr", "exhaustive", "yn-dod-i-ben", "expires", "teulu", "family", "enw-ffeil", "filename", "hidlydd", "filter", "fformatiwr", "formatter", "byd-eang", "global", "gwesteiwr", "host", "awr", "hour", "ff", "i", "cas-anwybyddu", "ignorecase", "marc-anwybyddu", "ignoremark", "yn", "in", "i-mewn", "into", "saer", "joiner", "cywair", "key", "gwrando", "listen", "gwesteiwr-lleol", "localhost", "porthladd-lleol", "localport", "cyfateb", "match", "uno", "merge", "munud", "minute", "modd", "mode", "mis", "month", "enw", "name", "eg", "nd", "nl-yn", "nl-in", "nl-allan", "nl-out", "di-rwystro", "non-blocking", "nfed", "nth", "i-ffwrdd", "off", "allan", "out", "allan-byffer", "out-buffer", "oh", "ov", "gorgyffwrdd", "overlap", "t", "p", "rhan", "partial", "rhan", "parts", "porthladd", "port", "post", "pos", "cynradd", "primary", "cwarterol", "quaternary", "rh", "r", "ydd", "rd", "go-iawn", "real", "amnewid", "replacement", "rheol", "rule", "rh", "rw", "o-r-un-achos", "samecase", "un-gofod", "samespace", "trefnydd", "scheduler", "eiliad", "second", "eilradd", "secondary", "eiliadau", "seconds", "wedi-eu-rhannu", "shared", "maint", "size", "MANYLION", "SPEC", "sboncen", "squash", "eg", "ss", "statws", "status", "llym", "strict", "tanysgrifiad", "subscript", "uwchysgrif", "superscript", "trydyddol", "tertiary", "prawf", "test", "eg", "th", "o-weithiau", "times", "cylchfa-amser", "timezone", "cyfieith-nl", "translate-nl", "blaenor", "truncate", "diweddariad", "update", "gwerth", "value", "vent-yn", "vent-at", "gyfrol", "volume", "gw", "w", "lle", "where", "ennill-verbatim-args", "win-verbatim-args", "flwyddyn", "year";
        %mapping{$key} // $key
    }
    method pragma2str (str $key) {
        my constant %mapping = "deinamig-gwmpas", "dynamic-scope", "angheuol", "fatal", "mewnol", "internals", "ddirym", "invocant", "MYNEGAI", "MONKEY", "MONKEY-GWELER-NO-EVAL", "MONKEY-SEE-NO-EVAL", "MYNEG-DDYN", "MONKEY-TYPING", "rhagluniaeth", "precompilation", "meddal", "soft", "llym", "strict", "olrhain", "trace", "o-newidynnau", "variables", "o-ofidiau", "worries";
        %mapping{$key} // $key
    }
    method system2str (str $key) {
        my constant %mapping = "DERBYNIADAU", "ACCEPTS", "ADEILADU", "BUILD", "GALWAD-ME", "CALL-ME", "COFIANT", "COERCE", "AWDL", "FALLBACK", "PRIF", "MAIN", "UWCHRADD-RAT", "UPGRADE-RAT";
        %mapping{$key} // $key
    }
}
